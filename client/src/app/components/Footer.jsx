        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mt-2 text-sm">
              Modern digital wallet for everyday payments. Fast, secure, and
          ...
          <FooterColumn
            title="Solutions"
            links={[
              { title: "Personal Payments", href: "#" },
              { title: "Business Transactions", href: "#" },
              { title: "International Transfers", href: "#" },
              { title: "Money Management", href: "#" },
            ]}
          />
          <FooterColumn
            title="Support"
    ...
    <div>
      ...
      <ul className="mt-4 space-y-4">
        {links.map((link, index) => (
          <li key={index}>
            <a href={link.href} className="text-sm hover:text-foreground">
              {link.title}
            </a>
          </li>
        ))}
